...
const CoverLetterGenerateForm = ({ profiles, isGenerating, onGenerate }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <Button
        ...
        className="w-full"
      >
        {isGenerating ? 'Generating Cover Letter...' : 'Generate Cover Letter with AI'}
      </Button>
    </form>
  );
};

export default CoverLetterGenerateForm;
